    ...
    <header className="relative overflow-hidden bg-transparent h-16">
      ...
      <nav className="relative z-20 container mx-auto px-4 h-full">
        <ul className="flex justify-center items-center space-x-6 rtl:space-x-reverse h-full">
          ...
          <li>
            <Link to="/request" className="text-white hover:text-jordan-red transition duration-300 text-lg">
              قدم طلب ترشيح
            </Link>
          </li>
          <li>
            <Link to="/services" className="text-white hover:text-jordan-red transition duration-300 text-lg">
              خدماتنا
            </Link>
          </li>
          <li>
